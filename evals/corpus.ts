...
//
// Measured, not chosen, and **re-measured when the corpus changed**. At 1.8 it
// was 0.62 -> 0.59 against nine authored passages. Slice 1.12 replaced those
// with the 71-clause tier-1 corpus, which moved both edges of the gap, so run
// 34015648330 measured it again:
//
//   answerable, worst top hit      0.4654   (חוזה §7.2)
//   unanswerable, best top hit     0.6474   (מה מזג האוויר מחר?)
//
// 0.59 still separated them, and it had stopped being *between* them: 0.125
// above the answers and 0.057 below the refusals, which is one edge of the gap
// rather than the middle of it. 0.56 is the midpoint of the measured gap, and a
// number this file has already had to move once is a number that needs the
// margin on both sides. The table is in tasks/evidence/1.12.md.
//
