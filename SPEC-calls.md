...
- **Builds:** week 8, agent-free and driven by hand from the console; the agent arrives in month three
  without changing any of it.
- **Carries:** **the state machine is deterministic and no model decides a transition.** SLA clocks,
  timers and escalation live here, as does the **emergency bypass**, built in week 8 because it must
